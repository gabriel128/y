...
ex1 :: [Stmt]
ex1 =
  [ Let (Native ImmTy I64) "a" (Const I64 (NativeInt 5)),
    Let (Native ImmTy I64) "b" (Const I64 (NativeInt 30)),
    Let (Native ImmTy I64) "c" (Var (Native ImmTy I64) "a"),
    Let (Native ImmTy I64) "b" (Const I64 (NativeInt 10)),
    Let (Native ImmTy I64) "b" (BinOp Add (Var (Native ImmTy I64) "b") (Var (Native ImmTy I64) "c"))
  ]

enrichedEx1 :: [EnrichedStmt]
enrichedEx1 =
  [ EnrichedStmt (StmtMetadata (fromList ["a"])) (Let (Native ImmTy I64) "a" (Const I64 (NativeInt 5))),
    EnrichedStmt (StmtMetadata (fromList ["a"])) (Let (Native ImmTy I64) "b" (Const I64 (NativeInt 30))),
    EnrichedStmt (StmtMetadata (fromList ["c"])) (Let (Native ImmTy I64) "c" (Var (Native ImmTy I64) "a")),
    EnrichedStmt (StmtMetadata (fromList ["b", "c"])) (Let (Native ImmTy I64) "b" (Const I64 (NativeInt 10))),
