...
-- ex1 :: [Stmt]
-- ex1 =
--   [ Let _ "a" (Const (NativeInt 5)),
--     Let _ "b" (Const (NativeInt 30)),
--     Let _ "c" (Var "a"),
--     Let _ "b" (Const (NativeInt 10)),
--     Let _ "b" (BinOp Add (Var "b") (Var "c"))
--   ]

-- enrichedEx1 :: [EnrichedStmt]
-- enrichedEx1 =
--   [ EnrichedStmt (StmtMetadata (fromList ["a"])) (Let _ "a" (Const (NativeInt 5))),
--     EnrichedStmt (StmtMetadata (fromList ["a"])) (Let _ "b" (Const (NativeInt 30))),
--     EnrichedStmt (StmtMetadata (fromList ["c"])) (Let _ "c" (Var "a")),
--     EnrichedStmt (StmtMetadata (fromList ["b", "c"])) (Let _ "b" (Const (NativeInt 10))),
--     EnrichedStmt (StmtMetadata (fromList [])) (Let _ "b" (BinOp _ Add (Var "b") (Var "c")))
--   ]
